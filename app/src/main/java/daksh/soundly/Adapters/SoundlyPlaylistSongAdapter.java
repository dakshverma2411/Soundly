...
public class SoundlyPlaylistSongAdapter extends RecyclerView.Adapter<SoundlyPlaylistSongAdapter.ViewHolder> {
    ...
    public SoundlyPlaylistSongAdapter(ArrayList<Song> songs, Context context, int numberOfSongs) {
        this.songs = songs;
    ...
    public int getItemViewType(int position) {
        return (position == songs.size()) ? R.layout.show_more_button : R.layout.list_item;
    }


    @NonNull
    @Override
    public SoundlyPlaylistSongAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView;
        ...
        if(viewType == R.layout.list_item){
            ...
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.show_more_button, parent, false);
        }

        return new SoundlyPlaylistSongAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final SoundlyPlaylistSongAdapter.ViewHolder holder, final int position) {
        if(position == songs.size()) {
            ...
            if(position==numberOfSongs || songs.size()==0)
            {
        ...
        else
        {
            ...
            holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    ArrayList<Song> thisSongOnly=new ArrayList<>();
                    thisSongOnly.add(song);
                    MainActivity.musicPlayerService.setSongs(thisSongOnly);
                    MainActivity.musicPlayerService.setCurrSongPosition(0);
            ...
            holder.more.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    popupMenu.inflate(R.menu.soundly_song_popup);
                    popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        @Override
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            switch (menuItem.getItemId())
                            {
                                case R.id.soundly_add_to_my_songs:
                                    Toast.makeText(context,"to be done",Toast.LENGTH_SHORT).show();
                                    break;


                                case R.id.soundly_add_to_playlist:
                                ...
                                case R.id.soundly_add_to_queue:
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            showMore=(Button) itemView.findViewById(R.id.showMoreButton);
